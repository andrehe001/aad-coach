...
namespace AdventureDay.ManagementApi.Helpers
{
    public class JwtMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, ITeamDataService teamService)
        {
        ...
        private void attachUserToContext(HttpContext context, ITeamDataService teamService, string token)
        {
            try
            {
