...
$policyparam = '{ "listOfSKUName": { "value": [ "GP_S_Gen5", "GP_Gen5" ] } }'
...
az policy assignment create --name 'deny-sql-db-skus' --scope '/subscriptions/{subId}/' --policy "sql-db-skus" --params "{'listofSKUName':{'value':['GP_S_Gen5', 'GP_Gen5']}}"
````
